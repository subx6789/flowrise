...
const components: JSXMapSerializer = {
  ...
  paragraph: ({ children }) => (
    <p className="text-xl md:text-2xl font-normal font-body to-slate-600 mb-8">
      {children}
    </p>
  ),
};
            ...
            item && (
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <p className="text-base font-medium to-slate-700">
                      {item.data.name}
                    </p>
                    <p className="text-base to-slate-600">
                      {item.data.job_title}
                    </p>
                  </div>
                </div>
